        ...
        <div className="col-12">
          <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div className="my-auto mb-2">
              <h3 className="page-title mb-1">Add New Agent</h3>
              <nav>
          ...
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">Agent Information</h4>
              ...
              <form onSubmit={handleSubmit}>
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <small className="text-muted">Initial status of the agent</small>
                  </div>
                  ...
                  <div className="col-12 mt-4">
                    <div className="d-flex gap-2 justify-content-end">
                      ...
                      <button type="submit" className="btn btn-primary" disabled={isLoading}>
                        <i className={`ti ${isLoading ? 'ti-loader ti-spin' : 'ti-user-plus'} me-2`} />
