...
const InstitutionsSchoolsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'institutions_cache') {
        console.log('Institutions cache updated, refreshing schools list...');
        fetchInstitutions();
      }
    };
  ...
  const fetchInstitutions = async () => {
    try {
      ...
      const response = await superAdminService.getInstitutionsByType('School');
      ...
      <div className="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div className="pe-1 mb-2">
            ...
            >
              <i className="ti ti-plus me-2"></i>Add School
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Total Schools</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Active Schools</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Suspended Schools</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Expired Schools</h5>
      ...
      <div className="card mb-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div>
              <span className="text-muted">Showing {filteredInstitutions.length} of {institutions.length} schools</span>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <tr>
                    <th>
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <span className="ms-2">School Name</span>
                      </div>
                    </th>
                    <th>Admin</th>
                    <th>Plan</th>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">Add School</h4>
...
export default InstitutionsSchoolsPage;