    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        if (darkModeToggle && lightModeToggle) {
            // Remove existing event listeners to avoid conflicts with React
            darkModeToggle.removeEventListener('click', enableDarkMode);
            lightModeToggle.removeEventListener('click', disableDarkMode);
        }
    });
