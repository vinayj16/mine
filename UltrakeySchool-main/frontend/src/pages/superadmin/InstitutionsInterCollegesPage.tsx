...
const InstitutionsInterCollegesPage: React.FC = () => {
  ...
  useEffect(() => {
    // Ensure demo user has proper authentication token
    const token = localStorage.getItem('accessToken');
    const isDemo = token && token.includes('demo');
    
    if (isDemo) {
      // For demo users, ensure we have a valid token structure
      const userRole = localStorage.getItem('userRole') || 'superadmin';
      const timestamp = Date.now();
      const demoToken = `demo-access-${userRole}-${timestamp}`;
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'institutions_cache') {
        console.log('Institutions cache updated, refreshing inter colleges list...');
        fetchInstitutions();
      }
    };
  ...
  const fetchInstitutions = async () => {
    try {
      ...
      const response = await superAdminService.getInstitutionsByType('Inter College');
      console.log('Fetched inter colleges:', response);
      
      setInstitutions(response || []);
    } catch (error) {
      console.error('Error fetching inter colleges:', error);
      const errorMessage = error instanceof Error ? error.message : 'Failed to load inter colleges';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Inter College created successfully');
      setShowAddModal(false);
      resetForm();
      fetchInstitutions();
    } catch (error: any) {
      console.error('Error creating inter college:', error);
      ...
      if (error.response?.data?.error?.details) {
        ...
        toast.error('Failed to create inter college. Please try again.');
      }
    }
  };
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Inter College updated successfully');
      setShowEditModal(false);
      setSelectedInstitution(null);
      fetchInstitutions();
    } catch (error) {
      console.error('Error updating inter college:', error);
      const errorMessage = error instanceof Error ? error.message : 'Failed to update inter college';
      toast.error(errorMessage);
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success('Inter College deleted successfully');
      setShowDeleteModal(false);
      setSelectedInstitution(null);
      fetchInstitutions();
    } catch (error) {
      console.error('Error deleting inter college:', error);
      const errorMessage = error instanceof Error ? error.message : 'Failed to delete inter college';
      toast.error(errorMessage);
    } finally {
      setLoading(false);
    }
    ...
    <div className="content bg-white">
      <div className="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
        <div className="my-auto mb-2">
          <h3 className="page-title mb-1">Inter Colleges Management</h3>
          <nav>
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active" aria-current="page">Inter Colleges</li>
            </ol>
          </nav>
        </div>
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div className="input-group me-2 mb-2">
            <input
              ...
              placeholder="Search inter colleges..."
              value={searchTerm}
          ...
          <div className="pe-1 mb-2">
            ...
            >
              <i className="ti ti-plus me-2"></i>Add Inter College
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Total Inter Colleges</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Active Inter Colleges</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Suspended Inter Colleges</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Expired Inter Colleges</h5>
      ...
      <div className="card mb-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div>
              <span className="text-muted">Showing {filteredInstitutions.length} of {institutions.length} inter colleges</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        <div className="card">
          <div className="card-body text-center py-4">
            ...
            <p className="mt-2 text-muted">Loading inter colleges...</p>
          </div>
        </div>
      ) : error ? (
        <div className="card">
          <div className="card-body text-center py-4">
            ...
            <button className="btn btn-primary" onClick={fetchInstitutions}>
                  ...
                  <tr>
                    <th>
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <span className="ms-2">Inter College Name</span>
                      </div>
                    </th>
                    <th>Admin</th>
                    <th>Plan</th>
                ...
                <tbody>
                  {filteredInstitutions.length > 0 ? (
                    filteredInstitutions.map((institution) => (
                      <tr key={institution._id || Math.random()}>
                        <td>
                          <div className="d-flex align-items-center">
                            <input
                              type="checkbox"
                        ...
                        <td>{institution.contactEmail || 'N/A'}</td>
                        <td>
                    ...
                    <tr>
                      <td colSpan={7} className="text-center py-4">
                        <div className="text-muted">
                          ...
                          <p className="text-muted mb-3">No inter colleges found</p>
                          <button 
                            className="btn btn-primary"
                            onClick={() => setShowAddModal(true)}
                          >
                            <i className="ti ti-plus me-2"></i>
                            Add First Inter College
                          </button>
                        </div>
                      </td>
                    </tr>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">Add Inter College</h4>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="modal-footer">
                  ...
                  <button type="submit" className="btn btn-primary">Add Inter College</button>
                </div>
              </form>
            </div>
          </div>
      ...
      {showEditModal && selectedInstitution && (
        <div className="modal fade show d-block" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }} tabIndex={-1}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">Edit Inter College</h4>
...
export default InstitutionsInterCollegesPage;
