...
router.get('/:id', schoolValidators.institutionIdValidator, schoolController.getSchoolById);  
...
router.put('/:id', schoolValidators.institutionIdValidator, schoolValidators.updateSchoolValidator, schoolController.updateSchool);  
router.delete('/:id', schoolValidators.institutionIdValidator, schoolController.deleteSchool);  
...
router.get('/metrics/:id', schoolValidators.institutionIdValidator, schoolController.getSchoolMetrics);  
...
router.get('/:id/admins', schoolValidators.institutionIdValidator, schoolController.getAdmins);  
