...
const InstitutionsEngineeringCollegesPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'institutions_cache') {
        console.log('Institutions cache updated, refreshing engineering colleges list...');
        fetchInstitutions();
      }
    };
  ...
  const fetchInstitutions = async () => {
    try {
      ...
      const response = await superAdminService.getInstitutionsByType('Engineering College');
      setInstitutions(response || []);
    } catch (error) {
      console.error('Error fetching engineering colleges:', error);
      toast.error('Failed to load engineering colleges');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Engineering College created successfully');
      setShowAddModal(false);
      resetForm();
      fetchInstitutions();
    } catch (error: any) {
      console.error('Error creating engineering college:', error);
      ...
      if (error.response?.data?.error?.details) {
        ...
        toast.error('Failed to create engineering college. Please try again.');
      }
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success('Engineering College deleted successfully');
      setShowDeleteModal(false);
      setSelectedInstitution(null);
      fetchInstitutions();
    } catch (error) {
      console.error('Error deleting engineering college:', error);
      toast.error('Failed to delete engineering college');
    }
  };
    ...
    <div className="content bg-white">
      <div className="d-md-flex d-block align-items-center justify-content-between border-bottom pb-3">
        <div className="my-auto mb-2">
          <h3 className="page-title mb-1">Engineering Colleges Management</h3>
          <nav>
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active" aria-current="page">Engineering Colleges</li>
            </ol>
          </nav>
        </div>
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div className="pe-1 mb-2">
            ...
            >
              <i className="ti ti-plus me-2"></i>Add Engineering College
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Total Engineering Colleges</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Active Engineering Colleges</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Suspended Engineering Colleges</h5>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="card-title mb-1">Expired Engineering Colleges</h5>
      ...
      <div className="card mb-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div>
              <span className="text-muted">Showing {filteredInstitutions.length} of {institutions.length} engineering colleges</span>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <tr>
                    <th>
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <span className="ms-2">College Name</span>
                      </div>
                    </th>
                    <th>Admin</th>
                    <th>Plan</th>
                    ...
                    <tr>
                      <td colSpan={7} className="text-center py-4">
                        <div className="text-muted">
                          <p className="text-muted">No engineering colleges found</p>
                        </div>
                      </td>
                    </tr>
                  )}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">Add Engineering College</h4>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="modal-footer">
                  ...
                  <button type="submit" className="btn btn-primary">Add Engineering College</button>
                </div>
              </form>
            </div>
          </div>
      ...
      {showEditModal && selectedInstitution && (
        <div className="modal fade show d-block" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }} tabIndex={-1}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">Edit Engineering College</h4>
...
export default InstitutionsEngineeringCollegesPage;
