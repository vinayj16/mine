/*
Author       : Dreamguys
Template Name: Ultrakey - Bootstrap Admin Template
*/

// Safe wrapper for jQuery plugins
var initOwlCarousel = function(selector, options) {
	if($(selector).length > 0 && $.fn.owlCarousel) {
...
$(document).ready(function(){
	...
	// Counter 
	if($('.counter').length > 0 && $.fn.counterUp) {
		$('.counter').counterUp({
			delay: 20,
			time: 2000
		});
	...
	$(document).on('mouseover', function(e) {
        e.stopPropagation();
        if ($('body').hasClass('mini-sidebar') && $('#toggle_btn1').is(':visible')) {
...
$(document).ready(function(){
	...
	if($('.link-slider').length > 0 && $.fn.owlCarousel) {      
